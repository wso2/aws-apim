...
This repository contains CloudFormation templates to deploy WSO2 API Manager Pattern 2 in Amazon Web Services(AWS).
...
![Successful stack](../images/apim-pattern-2.png)
